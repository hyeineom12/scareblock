...
정리한 네 곳이고, 가장 큰 곳이 **영화 9,000편 이상**이다.

**이것이 이 문제의 현재 해법이다.** 사용자는 볼 영화를 미리 검색해 타임스탬프를 확인하고,
재생 중에 시계를 본다. 9,000편이 손으로 정리돼 있다는 것은 **요구가 실재한다는 증거**다.
...
| 점프 스케어 시점 정보 제공 | ❌ **타임스탬프 DB 다수 존재** (최대 9,000편) | [§3.3](#33-점프-스케어-타임스탬프-데이터베이스--네-곳-규모가-크다) |
| **등재되지 않은 임의 영상에서 동작** | ✅ | DB·크라우드소싱 계열은 전부 사전 등재가 전제 |
...
**조사를 다시 하니 두 곳이 더 있었고 규모도 한 자릿수 컸다.**

| 사이트 | 규모 | 상태 |
|---|---|---|
| [NotScare](https://notscare.me/) | **영화 9,000편 이상 · 시리즈 140편 이상.** 강도 등급과 트리거 경고 포함 | 활성 |
| [WhenJumpScare](https://www.whenjumpscare.com/) | 자체 표방 "가장 크고 지속 갱신되는 타임스탬프 DB" | 활성 |
| [Where's The Scares](https://wheresthescares.com/) | 788개 타임스탬프 / 영화 152편 · TV 4시즌 · 게임 3종. "수동 검증" 표방 | 활성 |
| [Where's The Jump](https://wheresthejump.com/full-movie-list/) | 수백 편, 영화별 개수·평점 | **2023년 이후 갱신 중단** |
...
> **다만 이것을 「데이터 후보」로만 보면 절반을 놓친다.** 사람이 손으로 9,000편을 정리해
